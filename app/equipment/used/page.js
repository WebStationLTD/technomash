...
const usedEquipment = [
  ...
  },
  {
    ...
    features: [
      ...
      "Оптимизирано съхранение на енергия",
    ],
  },
  {
    id: 8,
  ...
  {
    id: 9,
    title: "GoodWe GW100K-HT",
    description: "GoodWe GW100K-HT – мрежов трифазен инвертор 100 kW от серията HT 1100 Vdc е високопроизводително решение, проектирано специално за търговски, индустриални и малки комунални соларни проекти. Благодарение на интелигентните функции за управление, надеждната защита и оптимизираната енергийна ефективност, този инвертор осигурява по-ниска цена на произведената електроенергия.",
    images: [
      "/goodwe-gw100k-ht.png",
    ],
    specifications: [
      "Номинална мощност: 100 kW",
      "Възможност за работа до 120 kW",
      "Входен ток на стринг: до 15A",
      "Съвместим с бифасциални модули",
    ],
    documents: [],
    features: [
      "Максимална ефективност и оптимизирано производство",
      "IP66 и C5 защита (устойчивост на прах, влага и корозия)",
      "Тип II защита от пренапрежение (SPD)",
      "Вграден мониторинг на температура и влажност",
      "Интелигентно управление и бърза конфигурация",
      "Детайлен мониторинг на стринг ниво",
    ],
  },
];
