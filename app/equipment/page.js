        ...
        <div className="mx-auto max-w-10/10 py-0 sm:px-6 sm:py-0 lg:px-0">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-12 text-center shadow-2xl sm:px-12">
            <div className="mx-auto max-w-3xl text-center">
              ...
              Оборудване за Фотоволтаични Централи
              </h1>
              <p className="mt-6 text-lg/8 text-white">
              Пълно системно решение
              </p>
            </div>
            <svg
      ...
      <div className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <p className="text-lg/8 text-gray-600 mb-8">
              За изграждането на ефективна и дълготрайна фотоволтаична инсталация качеството на всеки детайл е от решаващо значение. Ние предлагаме всичко необходимо за Вашия проект на едно място. Подбираме компонентите си спрямо най-високите технологични стандарти, за да гарантираме максимална производителност и бърза възвръщаемост на инвестицията Ви.
            </p>
            <h2 className="text-2xl font-semibold tracking-tight text-gray-900 mb-6">
              Какво включва нашето портфолио:
            </h2>
            <ul className="space-y-4 mb-8">
              {[
                { title: "Висококачествени соларни панели", text: "Работим с последно поколение модули от водещи производители, отличаващи се с висока ефективност дори при слаба осветеност и изключителна здравина." },
                { title: "Висококачествена стоманена конструкция", text: "Предлагаме сертифицирани монтажни системи с антикорозионно покритие, проектирани да издържат на сериозни ветрови и снежни натоварвания." },
                { title: "Инвертори", text: '"Сърцето" на Вашата централа. Разполагаме с високотехнологични инвертори (мрежови, хибридни или автономни) с интелигентни системи за мониторинг и управление.' },
                { title: "Батерии за съхранение", text: "Надеждни решения за енергийна независимост, които Ви позволяват да използвате произведената енергия по всяко време на денонощието." },
                { title: "Специализиран соларен кабел", text: "Кабели с висока устойчивост на UV лъчи и екстремни температурни амплитуди, гарантиращи безопасността и надеждността на връзките за десетилетия напред." },
              ].map((item, idx) => (
            ...
            <p className="text-lg/8 text-gray-600 mb-2 font-semibold">
              Свържете се с нас за наличности и консултация
            </p>
            <p className="text-lg/8 text-gray-600 mb-2">
              Пазарът на соларни технологии се развива динамично. За повече подробна техническа информация, индивидуални спецификации или проверка на актуалните наличности в нашия склад, не се колебайте да се свържете с нас.
            </p>
            <p className="text-lg/8 text-gray-600">
              Нашият екип е на разположение да Ви съдейства при избора на най-подходящото оборудване за Вашите нужди.
            </p>
          </div>
        </div>
      </div>
